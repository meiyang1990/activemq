...
public class DtoUdpTraceBrokerPlugin implements Equals, HashCode, ToString
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "address", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "wireFormatFactory", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class)
    })
