...
public class DtoMKahaDB implements Equals, HashCode, ToString
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "filteredPersistenceAdapters", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "transactionStore", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class)
    })
