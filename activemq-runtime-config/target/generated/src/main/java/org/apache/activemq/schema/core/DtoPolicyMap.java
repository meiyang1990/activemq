...
public class DtoPolicyMap implements Equals, HashCode, ToString
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "policyEntries", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class)
    })
        ...
        implements Equals, HashCode, ToString
    {
        ...
        @XmlElementRef(name = "policyEntry", namespace = "http://activemq.apache.org/schema/core", type = DtoPolicyEntry.class)
        @XmlAnyElement(lax = true)
