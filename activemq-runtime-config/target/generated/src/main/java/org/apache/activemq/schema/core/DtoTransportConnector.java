...
public class DtoTransportConnector implements Equals, HashCode, ToString
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "discoveryAgent", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class),
        @XmlElementRef(name = "publishedAddressPolicy", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class),
        @XmlElementRef(name = "brokerService", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class),
        @XmlElementRef(name = "brokerInfo", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class),
